...
%>
        ...
        %>
                                                                        <script>
                                                                            $(function() {
                                                                                $('#inviteFeedback').html('<span class=\"ui-state-highlight ui-corner-all\"><%out.print(request.getParameter("fname"));%> has been invited to the project. A notification has been sent to an administrator for activation.<span>');
                                                                            });
        ...
        %>
                                                                            <script>
                                                                                $(function() {
                                                                                    $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\"><%out.print(request.getParameter("fname"));%> has been invited to TPEN, but only the project leader may add someone to a project. A notification has been sent to an administrator for activation.<span>');
...
%>
                                                                                <script>
                                                                                    $(function() {
                                                                                        $('#inviteFeedback').html('<span class=\"ui-state-error ui-corner-all\"><%out.print(request.getParameter("fname"));%> seems to have an account already, please use the "Add to Project" option to include them on your team. If you have any further trouble, please contact TPEN.<span>');
                                                                                        $('#inviteFeedback').effect('pulsate', 500);
                                                                                    });
                                                                                                ...
                                                                                                $(window).load(function() {
                                                                                                            ...
                                                                                                            $("a:contains('Transcribe')").parent().each(function() {
                                                                                                                    $(this).removeClass('loadingBook').css("background", "url('<%
                                                                                                                        ...
                                                                                                                        textdisplay.Folio thisFolio = new textdisplay.Folio(pageno, true); out.print(thisFolio.getImageURLResize(600)); % > & quality = 30 ') -30px -60px no-repeat");
                                                                                                                    });
...
%>
                                                                    ...
                                                                    <ul id="options" class="ui-helper-reset">
                                                                        <li class="left ui-widget-content ui-corner-tr ui-corner-bl tall">
                                                                            ...
                                                                            <%if(isMember || permitModify){%>
                                                                                ...
                                                                                <div id="xmlImportDiv">
                                                                                    <div id="xmlImportBtn" class="tpenButton"><span class="ui-icon ui-icon-script right"></span> Link a schema to this project
                                                                                    </div>
                                                                                    <form id="xmlImport" name="xmlImport" class="ui-corner-all" action="project.jsp" method="POST">
                                                                                        ...
                                                                                        <input type="hidden" name="projectID" value="<%out.print(" " + projectID);%>"/> URL of schema:<input name="url" style="width:100%;margin:2px 0px 2px -1px" title="Link directly to a valid file"
                                                                                            type="text" placeholder="enter complete file URL" />
    ...
    if (thisProject.getSchemaURL().length() > 5) {%>
                                                                                    <div id="xmlValidateDiv">
                                                                                        <div id="xmlValidateBtn" class="tpenButton"><span class="ui-icon ui-icon-script right"></span> Validate XML for this project
                                                                                        </div>
                                                                                        <form id="xmlValidate" class="ui-corner-all" action="validate" method="POST">
                                                                                            <input type="hidden" name="selecTab" value="3" />
                                                                                            <input type="hidden" name="projectID" value="<%out.print(" " + projectID);%>"/> URL of schema for validation:
                                                                                            <div style="width:100%;margin:2px 0px 2px -1px">
                                                                                                <%out.print(thisProject.getSchemaURL());%>
                                                                                            </div>
         ...
         %>
                                                                                                    <div class="hideWhileCopying">
                                                                                                        ...
                                                                                                        <p>Create a new project with the same set of images and buttons. This copy will not include any transcription data, just project data. Once copied, the
                                                                                                            projects will not synchronize cannot be recombined in T&#8209;PEN.</p><br>
...
<%}%>
                                                                                    ...
                                                                                    <script type="text/javascript">
                                                                                        var folioDropdown = $('<div />').append('<%
                                                                                                ...
                                                                                                $(".folioDropdown").append(folioDropdown.html()); $("#pageRange").find("select")
                                    ...
                                    <label id="exportUseLinebreakString" class="" for="useLinebreakingString" title="Use this string in exported document"><input id="useLinebreakingString" type="checkbox"  value="true"/>Use linebreak string in exported document</label>-->
                                                    ...
                                                    <%if(isMember||permitModify){%>
                                                        <div id="addToProject">
                                                            <!-- container for adding to projects -->
                                                            <div class="callup" id="form">
                                                                <!-- add to project -->
...
%>
                                                                        <p class="ui-state-error ui-corner-all">
                                                                            <span class="ui-icon ui-icon-alert"></span> By default, only group members have access to the transcription and related project data. Changing any of these options will place
                                                                            this project on the Public Projects list.<br/>
            ...
            <span class=""><span class="left ui-icon ui-icon-notice"></span>Changes to metadata are not tracked in the project log.</span>
                                                            ...
                                                            <%}%>
                                                                <div id="addingTools" class="ui-corner-all ui-widget ui-widget-content">
                                                                    ...
                                                                    <a class="tpenButton" id="addToolPreview" onclick="$('#addToolFrame').attr('src',$('#addToolURL').val());">
                        Test Link
                    </a>
                                                                    <a class="tpenButton" id="addToolCommit" onclick="addTool();">
                        Add
                    </a>
