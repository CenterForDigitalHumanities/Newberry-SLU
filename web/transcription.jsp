...
background: url(css/custom-theme/images/ui-bg_dots-medium_75_ffebb9_4x4.png) 50% 50% repeat, rgba(166,65,41,.5);*/
        ...
        <script type="text/javascript">
                                                                                                    var firstFocus
            <%if (request.getParameter("currentFocus") != null) {
                    ...
                    out.println("compareIndex = '" + request.getParameter("compareIndex") + "';");
                                                                                                    ...
                                                                                                    $(function () {
                                                                                                        ...
                                                                                                        $(".glossary").append(function () {
                                                                                                            ...
                                                                                                            if (thisPos + thisWidth > tipWidth)
                                                                                                                thisPos = tipWidth - thisWidth;
                                                                                                            $(this).find(".gloss").css({
                                                                                                                left: -thisPos + "px",
                                                                                                                width: tipWidth + "px",
                                                                                                                top: thisHeight + "px"
        ...
        <div id="wrapper" class="ui-corner-all">
            ...
            <div id="workspace">
                ...
                <div id="entry">
                    ...
                    <textarea id="transcription<%out.print((i + 1));%>" class="ui-corner-all theText" <%if (!permitModify && !isMember) {
                                                                                                                            out.print(" readonly ");%>onkeydown="return Interaction.keyhandler(event);"><%out.print(thisText[i].getText().replace("&amp;", "&"));%></textarea>
                    <div class="xmlClosingTags" id="closeTags<%out.print((i + 1));%>">
                    </div>
                    <textarea style="display:none;" id="notes<%out.print((i + 1));%>" class="ui-corner-all notes" <%if (!permitModify && !isMember) {
                                                                                                                            out.print(" readonly ");%>><%if (thisText[i].getComment() != null && thisText[i].getComment().length() > 0) {
                                                                                                                            out.print(thisText[i].getComment());
                                                                                                                        }%></textarea>
...
continue;
                    ...
                    <div class="ui-widget-content ui-corner-all" id="options">
                        <div id="msOptions" class="left">
                            ...
                            <%}
                                                                                                                                        for (int ii = 0; ii < projectTools.length; ii++) {%>
                            <a class="iframeTools wBtn" href="<%out.print(projectTools[ii].getUrl());%>" target="frame<%out.print(ii);%>" id="frameBtn<%out.print(ii);%>" title="Access the <%out.print(projectTools[ii].getName());%> tool">
                                <%out.print(projectTools[ii].getName());%>
                            </a>
                            <%}%>
                        </div>
            ...
            <div id="linebreakSplit" class="ui-widget ui-widget-content">
                ...
                <div>
                    ...
                    <div id="linebreakText">
                        <span id="lbText"></span>
                        <%if (thisProject.getLinebreakCharacterLimit() == thisProject.getLinebreakText().length()) {
                                                                                                                                        out.print("<div id='charLimit' class='ui-corner-all ui-state-error-text small clear'>Showing the first " + thisProject.getLinebreakCharacterLimit() + " characters</div>");%>
                    </div>
                    <script type="text/javascript">
...
//                                annos.append("</div>");
//                            }
                            previewText = Transcription.getProjectTranscriptions(projectID, folioPreview[iii]);
                    ...
                    %>
                    <div class="previewPage" data-pageNumber="<%out.print((pageno - 1) + iii);%>">
                        <span class="previewFolioNumber"><%out.print(new Folio(folioPreview[iii]).getPageName().replaceAll(" ", "&nbsp;"));
                                                                                                                                            if (iii == 1)
                                                                                                                                                out.print(", <a name='currentPage' id='currentPage' style='text-decoration: none;'>Current&nbsp;Page</a>");%></span>
                        <%
                        ...
                        <div class="previewLine" data-lineNumber="<%out.print(line + 1);%>">
                            <span class="previewLineNumber" data-lineid="<%out.print(previewText[line].getLineID());%>" data-lineNumber="<%out.print(line + 1);%>" data-column="<%out.print(column);%>" data-lineOfColumn="<%out.print(line + 1 - columnLineShift);%>"><%
                                ...
                                %></span>
                            <span contentEditable="<%out.print((permitModify || isMember));%>" class="previewText<%if (i == 1) {
                                                                                                                                                        out.print(" currentPage ");%>"><%out.print(previewText[line].getText().replace("&amp;", "&"));%><span class="previewLinebreak"></span></span>
                            <span contentEditable="<%out.print((permitModify || isMember));%>" class="previewNotes<%if (i == 1) {
                                                                                                                                                        out.print(" currentPage ");%>"><%out.print(previewText[line].getComment());%></span>
                        </div>
                        <%}
//                        out.print(annos.toString());
            ...
            <% }
                ...
                for (int iiii = 0; iiii < projectTools.length; iiii++) {
                    String frameLink = projectTools[iiii].getUrl();
                    String frameName = projectTools[iiii].getName();
            %>
            <!--  Build Tool-->
            <div id="split<%out.print(iiii);%>">
                <div class="toolLinks">
                    <a href="<%out.print(frameLink);%>" target="frame<%out.print(iiii);%>" title="Reset this tool" class="frameReset">Reset<span class="ui-icon ui-icon-refresh left"></span></a>
                ...
                <div id="frameSplitDiv<%out.print(iiii);%>">
                    <iframe name="frame<%out.print(iiii);%>" id="frame<%out.print(iiii);%>" src="iframe.html">
                    </iframe>
                </div>
            </div>
            <%}%>
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                if (hasMessage) {
                    out.print("alert(unescape('Message from" + archive + ":\\n\\n" + (archiveMsg) + "'));");
                }
            %>
        </script>
